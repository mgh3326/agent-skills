...
#666 의 런그별 devin 빌더 철자 `builder-devin-medium`·`builder-devin-max`·`builder-ds41`·`builder-ds41-max`(각각 워커 변형과 동일 argv)와 #704 의 E6 측정 런그 철자(`builder-opus-low` 등 12개 — 위 단락 참조, `SCOPEFUEL_E6_ARM` 표식 필수)도 `--role builder`를 받는다.

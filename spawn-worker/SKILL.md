...
| 프로필 | reps 3건 전 임시 운용 제한 |
|---|---|
| `devin-swe2` | **A+ 추정**. reps 3건 완료 전에는 가역 `T1`/`T2`만 허용하며, 장기 다단계 작업과 `S` 이상은 제외한다. tester는 **타사 provider family**로 배정한다. 이 행은 reps 3 전 임시 운용 제한일 뿐, 장기 정본과 등급 조정은 scopefuel을 따른다. |
| `oc-solar4` | **B 추정**. T1 한정. tester 금지. 장문/KR 강, 다중턴 툴 약. 이 행은 reps 3 전 임시 운용 제한일 뿐, 장기 정본과 등급 조정은 scopefuel을 따른다. |

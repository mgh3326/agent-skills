...
FILE_FORBIDDEN = [
    ...
    ("core-class-lower-t",
     ...
     r"|주니어|초급|잡무|청소|보조|부수|저렴|싼|하급|가벼운|경량|vendor|freelance|crew|external|outside|third[- ]?party|consult\w*|helper|assistant|bargain|frugal|thrifty|discount|budget|low[- ]paid|cut[- ]?rate|seasonal|low[- ]?price|low[- ]?rate|work[- ]?queue|developer|programmer|coder|workforce|staffer|staffing|agency|offshore|nearshore|pooled|in[-\s]?house|operations|ops\b|back[- ]?office|support[- ]?desk|billing|cost[-\s]?controlled|cost[-\s]?conscious|regular|standard|normal|usual|ordinary|customary|steady|day[-\s]?to[-\s]?day)|(?:is|are|be|remains?|stays?|counts?\s+as|qualif\w*\s+as|classified\s+as|"
     ...
     r"하급|초급|주변|가벼운|경량|사무|심부름|vendor|freelance|crew|external|outside|third[- ]?party|consult\w*|helper|assistant|bargain|frugal|thrifty|discount|budget|low[- ]paid|cut[- ]?rate|staffing|agency|offshore|nearshore|pooled|in[-\s]?house|operations|ops\b|back[- ]?office|support[- ]?desk|billing|tiny|adapter|shim|glue|documentation|docs|paperwork|doc[- ]?work|low[- ]?price|seasonal|저비용|인력)\b)"),
    ("lower-t-first-core",
